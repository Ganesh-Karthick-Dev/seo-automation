  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-4">
      <div className="w-full max-w-[1200px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-[20px]">
              ...
              <div className="relative">
                <Input
                  ...
                  type="text"
                  placeholder="Name"
                  className="w-full h-[52px] border border-[#9d9d9d] rounded-[7px] px-4 text-[14.97px] font-medium text-[#656565] placeholder:text-[#656565] focus:border-[#1b3eed] focus:ring-1 focus:ring-[#1b3eed] bg-white"
                  {...register('name')}
                />
                {errors.name && (
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full h-[52px] border border-[#9d9d9d] rounded-[7px] px-4 pr-12 text-[14.97px] font-medium text-[#656565] placeholder:text-[#656565] focus:border-[#1b3eed] focus:ring-1 focus:ring-[#1b3eed] bg-white"
                  {...register('password')}
                />
                <button
                  type="button"
        ...
        {/* Signup Button - Full Width Below */}
        <div className="w-full max-w-[497px] mx-auto mt-8">
          <Button
            type="submit"
            onClick={handleSubmit(onSubmit)}
            disabled={isSubmitting || isLoading}
            className="w-full h-[52px] bg-[#1b3eed] hover:bg-[#1632d4] disabled:bg-[#9d9d9d] text-white font-semibold text-[14.97px] rounded-[7px] transition-colors border-none shadow-none"
          >
        ...
        <div className="text-center mt-8 space-y-4">
          <p className="text-black text-[14.97px] font-light max-w-[507px] mx-auto leading-[25px]">
